...
hoistedDependencies:
  ...
  p-locate@5.0.0:
    p-locate: private
  packages/core:
    '@rag-doctor/core': private
  packages/diagnostics:
    '@rag-doctor/diagnostics': private
  packages/ingestion:
    '@rag-doctor/ingestion': private
  packages/parser:
    '@rag-doctor/parser': private
  packages/reporters:
    '@rag-doctor/reporters': private
  packages/rules:
    '@rag-doctor/rules': private
  packages/types:
    '@rag-doctor/types': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Fri, 13 Mar 2026 07:43:06 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-msvc@4.59.0'
  - fsevents@2.3.3
storeDir: /root/Projects/rag-doctor/.pnpm-store/v3
